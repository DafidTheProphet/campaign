...
- Enemies within 10 feet of you must make a Wisdom saving throw (DC = 8 + your proficiency bonus + your Charisma modifier) at the start of their turn. On a failed save, they are charmed by you until the end of their next turn. This effect ends if the creature takes damage from you or your allies. Once a creature has been affected by this ability, it is immune to it for 24 hours.
- If an enemy is immune to charm, they instead receive a saving throw penalty equal to your cultivation modifier until the end of their next turn. 
- Any entities you have charmed are also beguiled (see above).

## External Path Technique: Mesmerizing Melody

- Your qi resonates in the air, playing a graceful, sultry song.
- As an action, spend 4 qi points to release a wave of entrancing qi. All enemies within a 30ft radius must make a Wisdom saving throw. 
	- On failure, the creature has their speed halved and cannot take reactions, becoming entranced. If you move within 5ft, they must make a Wisdom saving throw or become charmed. 
	- On a success, they suffer disadvantage on the next saving throw or attack roll they make before the end of their next turn. 
- If a creature is already charmed by you, they automatically fail the initial saving throw against this technique, becoming entranced.

## Path Law: Law of Entwined Desires

- Once per turn, when a creature makes a saving throw against being charmed or frightened by you, and fails, you may tie a crimson thread to them for 1 hour.
	- While a creature is threaded:
		- They cannot willingly target you with attacks, spells, or techniques unless they succeed a Wisdom saving throw at the start of their turn.
		- You may communicate telepathically with them as long as they are within 1 mile.
		- Once per short rest, you may cause them to experience phantom desire or fear, forcing them to either Dash toward or away from you (your choice) as a reaction.
- While a creature is charmed by you, any attempt to remove the condition (e.g., via magic or inspiration) must first succeed on a Charisma saving throw against your Cultivation DC. On a failure, the attempt does nothing, and the charmed creature becomes hostile to the one who tried to “free” them for 1 minute.
